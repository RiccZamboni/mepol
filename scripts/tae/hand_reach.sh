python src/experiments/mamepol.py --env "HandReach" \
    ...
    --num_trajectories 10 --trajectory_length 25 --num_epochs 20000 --heatmap_every 2000 \
    --heatmap_episodes 10 --heatmap_num_steps 25 --use_backtracking 1 --zero_mean_start 1 \
